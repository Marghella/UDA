...
export default function LogoReligione({ otherClass, animation, ...other }:LogoProps) {
  return <>
    <div className={styles.logo_religione}>
      {/* JUMP */}
      <Spring from={{ top: 0, left: 0, transform: 'rotate(0deg)' }} to={{ top: animation ? -15 : 0, left: animation ? -15 : 0, transform: animation ? 'rotate(-5deg)' : 'rotate(0deg)' }}>
        {(styless) => <>
          <a.div style={styless}>
      ...
      {/* VERSO DESTRA */}
      <Spring from={{ top: 0, left: 0, transform: 'rotate(0deg)' }} to={{ top: animation ? -35 : 0, left: animation ? -16 : 0, transform: animation ? 'rotate(30deg)' : 'rotate(0deg)' }}>
        {(ulivo) => <>
          <a.div style={ulivo}>
      ...
      {/* MARTELLO DOWN */}
      <Spring from={{ top: 0, left: 0, transform: 'rotate(0deg)' }} to={{ top: animation ? -5 : 0, left: 0, transform: animation ? 'rotate(5deg)' : 'rotate(0deg)' }}>
        {(martello) => <>
